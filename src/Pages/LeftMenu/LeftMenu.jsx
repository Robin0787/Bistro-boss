...
import { FaArrowCircleLeft, FaBars, FaCalendarAlt, FaCalendarCheck, FaCartArrowDown, FaHome, FaShoppingBag, FaSms, FaStackOverflow, FaWallet } from 'react-icons/fa';
    ...
    return (
        <div className="drawer">
            ...
            <div className="drawer-content flex md:block justify-center bg-indigo-900 ">
                ...
                <label htmlFor="my-drawer" className="py-4 text-center text-lg cursor-pointer block text-white bg-indigo-800 drawer-button md:hidden"><FaBars /></label>
            </div>
            <div className="drawer-side">
                <label htmlFor="my-drawer" className="drawer-overlay"></label>
                <ul className="menu p-6  md:px-2 lg:p-6  w-80 text-white bg-indigo-950 uppercase flex flex-col justify-center gap-5">
                    ...
                    <NavLink to={'/dashboard/my-home'}
                        ...
                        <span className='hidden md:inline'>User Home</span>
                    </NavLink>
                    ...
                    <label htmlFor='my-drawer' className='text-center cursor-pointer block text-red-500 drawer-button hidden md:flex items-center gap-2'><FaBars /> Close Menu </label>
